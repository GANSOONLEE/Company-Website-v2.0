...
@section('title', __('brand.create-panel'))

@section('subtitle', __('brand.create-panel-description'))

@section('main')

    <x-form.post :action="route('backend.admin.brand.store')" enctype="multipart/form-data">

        <div class="mb-3">
            <p class="text-xl mb-3">@lang('brand.image')</p>
        ...
        <div class="mb-3">
            <label for="name" class="form-label required">@lang('brand.name')</label>
