...
@section('app')
    ...
    <div class="flex justify-center align-items-center w-full h-[100vh]">
        ...
        <div class="fixed top-0 w-full h-full -z-1">
            <img class="w-full h-full object-cover" src="{{ asset('image/frozen air cond.webp') }}" alt="">
        </div>

        <div class="shadow bg-white border-1 border-solid border-gray-300 relative w-[80%] lg:w-[60%] rounded-md py-4 px-[1.5rem]" data-carousel="static" id="slider-form">
    
            <!-- Stepper -->
            <ol class="flex justify-evenly items-center w-full mb-4 gap-x-[.75rem] lg:gapx-0">
                <li class="bg-white flex items-center text-blue-500 gap-x-[.5rem] lg:gap-x-[1rem] cursor-pointer opacity-100" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0">
                    <span class="flex items-center justify-center w-8 h-8 border !border-blue-600 rounded-full shrink-0">
                        1
                    </span>
                    <span>
                        <h3 class="text-sm lg:text-base font-bold leading-tight">User info</h3>
                        <p class="text-sm">Basic information</p>
                    </span>
                </li>
                <li class="flex items-center text-gray-400 gap-x-[.5rem] lg:gap-x-[1rem] cursor-pointer opacity-100 aria-[current=true]:text-blue-500 group" aria-current="false" aria-label="Slide 2" data-carousel-slide-to="1">
                    ...
                    <span>
                        <h3 class="text-sm lg:text-base font-bold leading-tight">Company info</h3>
                        <p class="text-xs lg:text-sm">Step details here</p>
                    </span>
                </li>
            </ol>
                ...
                <div class="relative h-[26.5rem] w-full overflow-y-auto overflow-x-hidden lg:overflow-hidden">
                    <div class="px-2 hidden !w-full mr-[3px]" data-carousel-item="active">
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <div class="flex flex-col gap-y-[.5rem] lg:flex-row justify-between lg:gap-y-0 lg:gap-x-4 mb-2">
                                ...
                                <div class="w-full lg:w-[48%] hidden" data-container>
                    ...
                    <div class="px-2 hidden !w-full mr-[3px]" data-carousel-item>
                        ...
                        <div class="flex flex-col lg:flex-row justify-between gap-x-4">
                            <div class="mb-4 w-full lg:w-[48%]">
                                ...
                                <input placeholder="Birth Date" title="Please enter your birthday date" type="date" class="bg-gray-100 block w-full rounded-md border-1 border-solid border-gray-300 focus:bg-white" name="birthday" id="birthday" placeholder="Birthday" value="{{ old('birthday') }}" required>
                            </div>
                        ...
                        <div class="flex justify-between mt-2 lg:mt-0 align-items-center">
                            <!-- Prev -->
            ...
            <div class="flex justify-end mt-4">
                <a href="{{ route('auth.login.index') }}" class="w-full lg:w-[50%] text-sm text-blue-900 flex justify-start lg:justify-end gap-x-[.6rem] transition-all duration-200 ease-in-out hover:gap-x-[1rem]">
...
@push('after-body')
    <script>
        ...
        function showHideWhatasappPhone(event) {
            ...
            if (checkbox.checked){
                contactPhoneNumberContainer.classList.add('lg:!w-[48%]');
                whatappsPhoneNumberContainer.classList.remove('hidden');
                whatappsPhoneNumberInput.required = true;
            }else{
                contactPhoneNumberContainer.classList.remove('lg:!w-[48%]');
