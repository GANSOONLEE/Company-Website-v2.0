...
@section('app')
    ...
    <div class="mt-8 px-12.5">
        ...
        <div class="flex flex-wrap flex-row w-full justify-between gap-y-11 mt-10">
            ...
            <label for="change-password" class="flex gap-x-[1rem] border-2 border-solid border-gray-300 rounded-md px-4 py-4 w-[48%] h-auto cursor-pointer transition-all duration[.12s] ease-in-out hover:gap-x-[1.5rem] hover:border-blue-700">
                I want to change me password
                <i class="fa-solid fa-arrow-right"></i>
            </label>
    
            <label for="forget-password" class="flex gap-x-[1rem] border-2 border-solid border-gray-300 rounded-md px-4 py-4 w-[48%] h-auto cursor-pointer transition-all duration[.12s] ease-in-out hover:gap-x-[1.5rem] hover:border-blue-700">
                I forget my password
                <i class="fa-solid fa-arrow-right"></i>
            </label>
    
            <label for="delete-account" class="flex gap-x-[1rem] border-2 border-solid border-gray-300 rounded-md px-4 py-4 w-[48%] h-auto cursor-pointer transition-all duration[.12s] ease-in-out hover:gap-x-[1.5rem] hover:border-blue-700">
                I want delete my account
                <i class="fa-solid fa-arrow-right"></i>
            </label>
    
            <label for="hack-account" class="flex gap-x-[1rem] border-2 border-solid border-gray-300 rounded-md px-4 py-4 w-[48%] h-auto cursor-pointer transition-all duration[.12s] ease-in-out hover:gap-x-[1.5rem] hover:border-blue-700">
            ...
            <div class="hidden border !border-gray-200 rounded-md peer-checked/forget-password:block">
                ...
                <div class="px-[1.5rem] py-3 bg-gray-50">
                    ...
                    <x-form.post :action="route('auth.password.reset')">
                        <input class="border border-gray-500 -mr-[4px] rounded-l-sm w-[20rem]" type="text" name="email" placeholder="Email" required>
