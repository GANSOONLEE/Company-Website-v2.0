...
@section('app')
    ...
    <a href="{{ route('frontend.home') }}#promotionControls" class="flex items-center fixed top-30 right-[0] max-w-sm py-[0.425rem] px-3 pr-8 translate-x-[11px] bg-white border border-gray-200 rounded-md shadow hover:bg-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
