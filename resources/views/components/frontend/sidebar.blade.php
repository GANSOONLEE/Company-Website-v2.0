...
<div id="sidebar" class="z-99 bg-blue-500 fixed -left-100 top-0 h-full w-60 overflow-y-auto no-scrollbar transition-all duration-100 ease-in-out px-4 py-17">
