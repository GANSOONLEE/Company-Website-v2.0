...
<tr class="hover:bg-gray-200 dark:hover:bg-gray-800">
    ...
    <td class="px-6 py-4">
        <button data-bs-toggle="modal" data-bs-target="#editModalForm" id="editButton" class="font-medium text-blue-600 dark:text-blue-500 hover:underline disabled:hover:no-underline disabled:text-slate-700 disabled:cursor-not-allowed dark:disabled:text-slate-700" {{ $attributes['weight'] }} >Edit</button>
    </td>
</tr>